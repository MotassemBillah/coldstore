        ...
        <tr>
            <td class="wmd_70">
                <form class="search-form" method="post" name="frmSearch" id="frmSearch">
                    <input type="hidden" name="dataKey" value="<?php echo $model->_key; ?>">
    ...
    <div id="printDiv">
        ...
        <table class="table table-bordered tbl_invoice_view no_mrgn">
            <tr>
                ...
                <td><strong>Father : </strong><?php echo!empty($model->father_name) ? $model->father_name : ''; ?></td>
            ...
            <tr>
                <td><strong>Stock : </strong><?php echo ProductIn::model()->customerStock($model->id); ?></td>
                <td><strong>Empty Bag : </strong><?php echo ProductIn::model()->customerEmptyBag($model->id); ?></td>
                <td><strong>Loan Given : </strong><?php echo LoanItem::model()->sumTotalCustomer($model->id); ?></td>
                <td><strong>AVG Loan : </strong><?php echo LoanItem::model()->avgLoanCustomer($model->id); ?></td>
            </tr>
        </table>
        <div id="ajaxContent">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#search', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + "/customer/search_ledger/",
