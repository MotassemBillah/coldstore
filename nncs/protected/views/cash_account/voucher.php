...
$this->breadcrumbs = array(
    'Cash' => array(AppUrl::URL_CASH_ACCOUNT),
    'Voucher',
);
?>
<div class="content-panel">
    <div id="printDiv">
        <div class="clearfix mb_10 mb_50 mp_mt" style="border-bottom:1px solid #ccc;margin-bottom:50px;padding-bottom:50px;">
            ...
            <table class="table table-striped table-bordered">
                <tr class="bg_gray">
                    <th class="text-center">খরচের বিবরন</th>
                    <th class="text-right">টাকার পরিমান</th>
                </tr>
                <tr>
                    <td><?php echo $model->purpose; ?></td>
                    <td class="text-right"><?php echo $model->debit; ?></td>
                </tr>
                <tr class="bg_gray">
                    <td>
                        <strong>কথায় :</strong> <?php echo AppHelper::int_to_words($model->debit); ?>
    ...
    <div class="clearfix">
        <div class="form-group text-center">
            ...
            <a href="<?php echo Yii::app()->createUrl(AppUrl::URL_CASH_ACCOUNT_DEPOSIT); ?>"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo Yii::t("strings", "New"); ?></button></a>
        </div>
    </div>
</div>