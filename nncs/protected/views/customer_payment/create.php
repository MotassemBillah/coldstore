...
<div class="row content-panel">
    <div class="col-md-12">
        ...
        <div class="row clearfix">
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    ...
                    echo $form->dropDownList($model, 'customer_id', $list, array('empty' => 'Select', 'class' => 'form-control', 'required' => 'required'));
                    ?>
                </div>
            </div>
            <div class="col-md-3 col-sm-4">
            ...
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    ...
                    echo $form->dropDownList($model, 'payment_type', $typeList, array('empty' => 'Select', 'class' => 'form-control', 'required' => 'required'));
                    ?>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'loan_bag'); ?>
                    <?php echo $form->numberField($model, 'loan_bag', array('class' => 'form-control', 'min' => 0, 'oninput' => "multiply_value(this, '#CustomerPayment_loan_bag_amount')", "data-target" => "#CustomerPayment_loan_bag_cost")); ?>
                </div>
            </div>
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'loan_bag_cost'); ?>
                    <div class="input-group">
                        <?php echo $form->textField($model, 'loan_bag_cost', array('class' => 'form-control', 'oninput' => "multiply_value(this, '#CustomerPayment_loan_bag_amount')", "data-target" => "#CustomerPayment_loan_bag")); ?>
            ...
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'loan_bag_amount'); ?>
                    <div class="input-group">
                        <?php echo $form->textField($model, 'loan_bag_amount', array('class' => 'form-control amount', 'readonly' => 'readonly')); ?>
                        <span class="input-group-addon">Tk</span>
                    </div>
                </div>
            </div>
        ...
        <div class="row clearfix">
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'delivered_qty'); ?>
                    <?php echo $form->numberField($model, 'delivered_qty', array('class' => 'form-control', 'min' => 0, 'oninput' => "multiply_value(this, '#CustomerPayment_delivered_cost_amount')", "data-target" => "#CustomerPayment_delivered_cost")); ?>
                </div>
            </div>
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'delivered_cost'); ?>
                    <div class="input-group">
                        <?php echo $form->textField($model, 'delivered_cost', array('class' => 'form-control', 'oninput' => "multiply_value(this, '#CustomerPayment_delivered_cost_amount')", "data-target" => "#CustomerPayment_delivered_qty")); ?>
                        <span class="input-group-addon">Tk</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-4">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'delivered_cost_amount'); ?>
                    <div class="input-group">
                        <?php echo $form->textField($model, 'delivered_cost_amount', array('class' => 'form-control amount', 'readonly' => 'readonly')); ?>
                        <span class="input-group-addon">Tk</span>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function multiply_value(elm, target) {
        ...
        $(target).val(!isNaN(_total) ? _total : '');
        get_sum('amount', 'CustomerPayment_net_amount');
    }
</script>