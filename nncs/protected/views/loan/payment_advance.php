                ...
                <div class="panel-body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-3 col-sm-3">
                            ...
                            <div class="form-group">
                                <label>Loan Bag Quantity</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="loan_bag" name="loan_bag">
                                    <span class="input-group-addon">@<?php echo $loanSetting->empty_bag_price; ?>&nbsp;Tk</span>
                                </div>
                            </div>
                            <div class="form-group">
