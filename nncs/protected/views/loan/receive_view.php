        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped table-bordered tbl_invoice_view">
                <tr class="bg_gray">
                    ...
                    <th style="">SR Number</th>
                    <th style="">Lot No</th>
                    <th style="width:15%">Customer</th>
                    <th style="width:15%">Father</th>
                    <th style="width:23%">Address</th>
                    <th class="text-center" style="width:5%">Qty</th>
                    <th class="text-center" style="width:5%">Qty Price</th>
                    <th class="text-right" style="">Loan Amount</th>
                    <th class="text-center" style="width:4%">Day</th>
                    <th class="text-right" style="">Interest</th>
                    <th class="text-right" style="">Total</th>
                    <th class="text-center dis_print" style="width:7%">Single</th>
                </tr>
                <?php
                $sum_qty = [];
                $sum_amount = [];
                if (!empty($model->items) && count($model->items) > 0):
                    ...
                    foreach ($model->items as $item) :
                        ...
                        <tr>
                            ...
                            <td><?php echo $item->customer->father_name; ?></td>
                            <td>
                                <?php
                                echo!empty($item->customer->village) ? $item->customer->village : '';
                                echo!empty($item->customer->thana) ? ', ' . $item->customer->thana : '';
                                echo!empty($item->customer->district) ? ', ' . $item->customer->district : '';
                                ?>
                            </td>
