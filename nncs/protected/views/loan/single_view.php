    ...
    <div id="printDiv">
        ...
        <div class="clearfix mb_10">
            <div class="col-md-4 mpw_33">
				<span style="display:inline-block;font-size:16px;font-weight:600;padding:2px 0;width:230px;">এস আর নং</span><br>
				<span style="display:inline-block;font-size:20px;font-weight:600;padding:2px 0;width:230px;"><?php echo AppHelper::en2bn($model->sr_no); ?>/<?php echo AppHelper::en2bn($model->qty); ?></span>
            </div>
        ...
        <div class="clearfix">
            <div class="col-md-4 form-group mpw_33" style="padding-top:30px;width:16.5%">
			...
			<div class="col-md-4 form-group mpw_33" style="padding-top:30px;width:16.5%">
                <div style="border-top:1px solid #000000;text-align:center;"><?php echo Yii::t("strings", "পরিচালক"); ?></div>
            </div>
        </div>
    </div>
    <div class="clearfix">
