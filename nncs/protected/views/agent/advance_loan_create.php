...
$this->breadcrumbs = array(
    'Agent' => [AppUrl::URL_AGENT],
    'Loan' => $this->createUrl(AppUrl::URL_AGENT_LOAN, ['id' => $model->_key]),
    'Advance'
);
?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row clearfix">
                        <input type="hidden" id="agent_code" name="agent_code" value="<?php echo $model->code; ?>">
