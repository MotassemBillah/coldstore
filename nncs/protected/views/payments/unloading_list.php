        ...
        <tr>
                ...
                <form class="search-form" method="post" name="frmSearch" id="frmSearch">
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <button type="button" id="clear_from" class="btn btn-primary" data-info="/payments/list_unloading">Clear</button>
                        </div>
                    </div>
                </form>
            </td>
            <td class="text-right wmd_30" style="">
                <?php if ($this->hasUserAccess('loading_payment_create')): ?>
                    <a class="btn btn-success btn-xs" href="<?php echo $this->createUrl(AppUrl::URL_PAYMENT_UNLOADING_NEW); ?>"><i class="fa fa-plus"></i>&nbsp;<?php echo Yii::t('strings', 'New'); ?></a>
                <?php endif; ?>
                        ...
                        <tr class="">
                            ...
                            <td class="text-center">
                                <?php if ($this->hasUserAccess('loading_payment_edit')): ?>
                                    <a class="btn btn-info btn-xs" href="<?php echo $this->createUrl(AppUrl::URL_PAYMENT_UNLOADING_EDIT, ['id' => $data->_key]); ?>"><?php echo Yii::t('strings', 'Edit'); ?></a>
                                <?php endif; ?>
                            </td>
                            <?php if ($this->hasUserAccess('loading_payment_delete')): ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", "#search", function(e) {
            ...
            $.ajax({
                type: "POST",
                url: ajaxUrl + "/payments/list_unloading",
