        ...
        <tr>
                ...
                <form class="search-form" method="post" name="frmSearch" id="frmSearch">
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <button type="button" id="clear_from" class="btn btn-primary" data-info="/payments/list_pallot">Clear</button>
                        </div>
                    </div>
                </form>
            </td>
            <td class="text-right wmd_30" style="">
                <?php if ($this->hasUserAccess('loading_payment_create')): ?>
                    <a class="btn btn-success btn-xs" href="<?php echo $this->createUrl(AppUrl::URL_PAYMENT_PALLOT_NEW); ?>"><i class="fa fa-plus"></i>&nbsp;<?php echo Yii::t('strings', 'New'); ?></a>
                <?php endif; ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", "#search", function(e) {
            ...
            $.ajax({
                type: "POST",
                url: ajaxUrl + "/payments/list_pallot",
        ...
        $(document).on('click', '#admin_del_btn', function(e) {
            ...
            if (_rc === true) {
                ...
                var _url = ajaxUrl + '/payments/deleteall_pallot';
