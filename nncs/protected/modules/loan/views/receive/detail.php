        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped table-bordered tbl_invoice_view">
                <tr class="bg_gray">
                    ...
                    <th>Loan Bag Qty</th>
                    <th>L.B Price</th>
                    <th>L.B Price Total</th>
                    <th>Total Qty</th>
                    <th>Quantity Price</th>
                    <th>Total loan</th>
                    <th>Loan Taken Person</th>
                </tr>
                <tr>
                    <td><?php echo $model->advance; ?></td>
                    <td><?php echo $model->cash; ?></td>
                    <td><?php echo $model->carrying_total; ?></td>
                    <td><?php echo $model->loan_bag_qty; ?></td>
                    <td><?php echo $model->loan_bag_price; ?></td>
                    <td><?php echo $model->loan_bag_price_total; ?></td>
                    <td><?php echo $model->qty_total; ?></td>
                    <td><?php echo $model->qty_price; ?></td>
                    <td><?php echo $totalAmount; ?></td>
                    <td><?php echo $model->taken_person; ?></td>
                </tr>
            </table>
