                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered tbl_invoice_view">
                        <tr id="r_checkAll">
                            ...
                            <th class="text-center"><?php echo Yii::t('strings', 'Per Qty Loan'); ?></th>
                            <th class="text-right"><?php echo Yii::t('strings', 'Loan Amount'); ?></th>
                            <th class="text-center"><?php echo Yii::t('strings', 'Days'); ?></th>
                            <th class="text-right"><?php echo Yii::t('strings', 'Interest'); ?></th>
                            <th class="text-right"><?php echo Yii::t('strings', 'Received Amount'); ?></th>
                        ...
                        foreach ($dataset as $data):
                            ...
                            <tr>
                                ...
                                <td class="text-center dis_print">
                                    ...
                                    <a class="btn btn-primary btn-xs" href="#"><?php echo Yii::t("strings", "View"); ?></a>
                                </td>
                                <?php if ($this->hasUserAccess('loan_receive_delete')): ?>
